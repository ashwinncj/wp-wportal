...
global $wpdb;
$sql = "SELECT b.`name` AS product_name , b.`image` AS product_image, `purchase_date`, `expiry_date`, `serial_number` FROM `wp_wportal_customer_records` a JOIN `wp_wportal_products` b ON a.product=b.id WHERE `user_id`='$user_id' ORDER BY purchase_date DESC";
